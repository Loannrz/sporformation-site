...
export type ActivityAction =
  ...
  | "TEACHER_SELF_SIGNUP"
  | "TEACHER_ONBOARDING_DOC_UPLOADED"
  | "TEACHER_ONBOARDING_BUNDLE_SUBMITTED"
  | "TEACHER_DOC_REQUEST_ADDED"
  | "TEACHER_DOC_REQUEST_REMOVED"
  | "TEACHER_ONBOARDING_APPROVED"
  | "TEACHER_ONBOARDING_APPROVAL_REVOKED"
  | "TEACHER_ONBOARDING_BUNDLE_RESET"
  | "TEACHER_VOLUNTARY_DOC_REQUEST_CREATED"
  | "TEACHER_VOLUNTARY_DOC_REQUEST_CLOSED"
  | "TEACHER_VOLUNTARY_DOC_UPLOADED"
  | "TEACHER_VOLUNTARY_DOC_RECIPIENT_EXCUSED"
  | "TEACHER_VOLUNTARY_DOC_MARKED_INVALID";
...
const ACTION_CATEGORY: Record<ActivityAction, ActivityCategory> = {
  ...
  TEACHER_ONBOARDING_DOC_UPLOADED: "accounts",
  TEACHER_ONBOARDING_BUNDLE_SUBMITTED: "accounts",
  TEACHER_DOC_REQUEST_ADDED: "accounts",
  TEACHER_DOC_REQUEST_REMOVED: "accounts",
  TEACHER_ONBOARDING_APPROVED: "accounts",
  TEACHER_ONBOARDING_APPROVAL_REVOKED: "accounts",
  TEACHER_ONBOARDING_BUNDLE_RESET: "accounts",
  TEACHER_VOLUNTARY_DOC_REQUEST_CREATED: "accounts",
  TEACHER_VOLUNTARY_DOC_REQUEST_CLOSED: "accounts",
  TEACHER_VOLUNTARY_DOC_UPLOADED: "accounts",
  TEACHER_VOLUNTARY_DOC_RECIPIENT_EXCUSED: "accounts",
  TEACHER_VOLUNTARY_DOC_MARKED_INVALID: "accounts",
};
